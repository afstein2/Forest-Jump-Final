/**
 * ButtonUI.js — Shared utility for creating styled menu buttons.
 *
 ...
 * 
 * Built with the help of z-ai/glm-5.1 via OpenRouter
 */
...
class ButtonUI {
    ...
    static create(scene, x, y, label, onClick, width = 250, height = 60) {
        ...
        ButtonUI._drawRoundedRect(graphics, width, height, cornerRadius, 0x000000, 0.5);
        ...
        hitArea.on('pointerover', () => {
            ButtonUI._drawRoundedRect(graphics, width, height, cornerRadius, 0xffffff, 0.3);
            text.setFontSize(30);
        });
